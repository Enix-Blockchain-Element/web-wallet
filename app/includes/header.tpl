...
<head>
  ...
  <title>ENIX Web Wallet</title>
  <meta property="og:title" content="wallet.enix.ai: Your Key to Enix">
  <meta property="og:site_name" content="wallet.enix.ai: Your Key to Enix">
  <meta name="twitter:title" content="wallet.enix.ai: Your Key to Enix">
  <meta name="apple-mobile-web-app-title" content="wallet.enix.ai: Your Key to Enix">
  <link href="https://wallet.enix.ai" rel="canonical">
  <meta content="https://wallet.enix.ai" property="og:url">
  <meta content="https://wallet.enix.ai" name="twitter:url">
  <link rel="stylesheet" href="css/etherwallet-master.min.css">
  <script type="text/javascript" src="js/etherwallet-static.min.js"></script>
  <script type="text/javascript" src="js/etherwallet-master.js"></script>
  <meta name="description" content="wallet.enix.ai is a free, open-source, client-side interface for generating Enix wallets & more. Interact with the Enix blockchain easily & securely.">
  <meta property="og:description" content="Free, open-source, client-side Enix wallet. Enabling you to interact with the blockchain easily & securely.">
  <meta name="twitter:description" content="Free, open-source, client-side Enix wallet. Enabling you to interact with the blockchain easily & securely.">
  ...
  <meta property="og:url" content="https://wallet.enix.ai" />
  <script type="application/ld+json">
    {
      ...
      "logo": "https://wallet.enix.ai/images/myetherwallet-logo.png",
      "description": "wallet.enix.ai is a free, open-source, client-side interface for generating Enix wallets &amp; more. Interact with the Enix blockchain easily &amp; securely.",
      "sameAs": [
        "https://wallet.enix.ai/",
      ]
    }
  </script>
...
<body>
  ...
  <header class="{{curNode.name}} {{curNode.service}} {{curNode.service}} nav-index-{{gService.currentTab}}" aria-label="header" ng-controller='tabsCtrl'>
    ...
    <div class="small announcement announcement-mew">
      <div clas="container">
        DON'T GET PHISHED, please! 🎣 Thank you! 🤗 Make sure you're on https://wallet.enix.ai
      </div>
    </div>
    }
    ...
    <section class="bg-gradient header-branding">
      <section class="container">
        ...
        <a class="brand" href="/" aria-label="Go to homepage">
          <img src="images/myetherwallet-logo.png" height="5%" width="5%" alt="Enix" />
          <p class="small visible-xs">3.38.0</p>
        </a>
        }
        @@if (site === 'cx' ) {
        <a class="brand" href="/cx-wallet.html" aria-label="Go to homepage">
          <img src="images/logo-myetherwalletcx.svg" height="5%" width="5%" alt="Enix" />
          <p class="small visible-xs">3.38.0</p>
        </a>
        }
        <div class="tagline">
